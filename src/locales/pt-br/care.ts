  ...
  care: {
    institutional: {
      ...
      metrics: {
        ...
        years: "Anos de história do Grupo Imagem",
        units: "Unidades de saúde atendidas",
        equipments: "Equipamentos em operação",
        cities: "Municípios atendidos",
        states: "Estados brasileiros",
        reports: "Laudos realizados"
      }
    },
    market: {
    ...
    problem: {
      ...
      impacts: [
        ...
        "Custo elevado com múltiplos deslocamentos",
        "Desperdício de recursos com exames repetidos",
        "Experiência negativa e estressante para o paciente"
      ],
      callout: "Uma jornada longa e fragmentada gera ineficiência, demora e baixa qualidade na experiência do paciente."
    },
    solution: {
      title: "A Solução CareImagem",
      subtitle: "Organizando a jornada completa do diagnóstico",
      description: "A CareImagem organiza toda a jornada do diagnóstico em uma única operação, reduzindo etapas, aumentando a eficiência e melhorando significativamente a experiência do paciente.",
      benefitsTitle: "Benefícios da Solução",
      benefits: [
        "Redução drástica no tempo de espera pelo diagnóstico",
        "Todos os exames realizados em um único local (One-Stop-Shop)",
        "Histórico clínico integrado e acessível via portal do paciente",
        "Experiência do paciente superior com atendimento humanizado",
        "Apoio direto à decisão clínica do médico solicitante"
      ],
      preventiveTitle: "Cuidado Preventivo e Ágil",
      preventiveBody: "A CareImagem não apenas realiza exames; ela organiza um ecossistema de cuidado preventivo. Através da agilidade diagnóstica, permitimos que tratamentos comecem mais cedo, aumentando as chances de cura e reduzindo custos para todo o sistema de saúde."
    },
    ecosystem: {
    ...
    implantation: {
      ...
      subtitle: "Do planejamento ao primeiro dia de operação",
      description: "A CareImagem entrega toda a estrutura de implantação da unidade, desde o planejamento até a operação. O franqueado conta com suporte completo em todas as áreas, incluindo regulatório, equipe e processos padronizados.",
    ...
    scale: {
      title: "Resultado e Escala",
      subtitle: "Modelo validado para crescer com segurança",
      description: "Com a CareImagem, você não começa do zero. Você entra em um modelo validado, integrado e escalável, que reduz riscos, aumenta a previsibilidade e acelera o retorno sobre o investimento.",
      diffTitle: "Diferenciais de Escala",
      diffs: [
        "Marca forte e consolidada",
        "Acesso preferencial a novos equipamentos",
        "IA aplicada para produtividade médica",
        "Ecossistema completo de suporte GI"
      ],
      perpetuityTitle: "Escalabilidade e Perpetuidade",
      perpetuityBody: "O modelo CareImagem foi desenhado para ser replicável. Uma vez estabilizada a primeira unidade, o franqueado possui o suporte necessário para expandir para novas regiões com o mesmo padrão de excelência.",
      profileTitle: "Perfil ideal do franqueado",
      profiles: [
        "Empreendedor com visão de longo prazo",
        "Não precisa ser profissional de saúde",
        "Capital disponível para investimento",
        "Identificação com o propósito da marca"
      ],
    ...
    comparison: {
      ...
      cash: {
        ...
        total: "R$ 1.797.000",
        monthly: "R$ 29.950/mês",
        formula: "1.797.000 ÷ 60 = R$ 29.950/mês",
        consideration: "Considerações",
        considerationText: "Equipamento: Tomógrafo Aquilion Start 16 canais 2 MHU",
        considerationTerm: "Considerar prazo de 60 meses",
        table: {
      ...
      financed: {
        ...
        monthly: "R$ 39.698,77/mês",
        formula: "25.915,43/mês × 60 = R$ 1.554.925,95",
        description: "Taxa: 1,7% ao mês — 60 meses",
        parcel: "Parcela: R$ 25.915,43/mês",
        ...
        table: {
          financing: "Financiamento equipamento",   financingCalc: "R$ 25.915,43/mês × 60",
          tube: "Tubo",                             tubeCalc: "60 meses",
      ...
      rental: {
        ...
        effectiveMonthly: "R$ 19.690,71/mês",
        monthlyLabel: "Custo Mensal Efetivo",
        taxBenefit: "Recuperação de R$ 900.394,68",
